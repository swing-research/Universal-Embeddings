...
#######################################
# Save
model_name = "Sphere_dimension_MG" # results will be saved in results/model_name
    ...
    if train:
        ...
        for ep in range(epochs):
            ...
            if ep%Ntest==0 and ep!=0:
                ...
                out = net_MG(input)
                dist_mat_test = utils.dist_W2_MG_1D(out,blur,scaling)
