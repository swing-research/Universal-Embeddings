...
"""
Illustrate the embedding into MG2 of a tree using the proposed probabilistic transformer.
"""

# Save
model_name = "Tree_MG" # results will be saved in results/model_name
    ...
    for ep in range(epochs):
        ...
        if ep%(np.max([epochs//10000,Ntest]))==0 and ep!=0:
            for param_group in optimizer.param_groups:
                param_group["lr"] = lr*(1-(1-0.001)*ep/epochs)
